...
public class Globals {
    ...
    public static int L1_SIZE_IN_NUMBER_OF_LINES = 8192/CACHE_LINE_SIZE; // roughly 1% of TOTAL_MEMORY_SIZE
    /*
     * LATENCIES
     */
    ...
    public static void setNumberOfLines(int newLines) {
        L1_SIZE_IN_NUMBER_OF_LINES = newLines;
    }

    public static String getGlobalsString() {
        return "MAIN_MEMORY_LATENCY = " + MAIN_MEMORY_LATENCY + " L1_NUM_LINES = " + L1_SIZE_IN_NUMBER_OF_LINES + " BUS_LATENCY = " + CACHE_COHERENCE_BUS_LATENCY;
    }
