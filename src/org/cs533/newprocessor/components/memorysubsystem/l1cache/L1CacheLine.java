...
public class L1CacheLine extends CacheLine {
    ...
    public enum L1LineStates {
        ...
        Valid, EXCLUSIVE_VALID, EXCLUSIVE_DIRTY, Dirty_Valid, Invalid, INVALIDATE_AFTER_WRITE_BACK
    }
    public L1LineStates currentState;

    public boolean validForRead() {
        return (currentState == L1LineStates.Valid) ||
                (currentState == L1LineStates.EXCLUSIVE_DIRTY) ||
